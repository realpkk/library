"ace" in window || (window.ace = {}), "helper" in window.ace || (window.ace.helper = {}), "options" in window.ace || (window.ace.options = {}), "vars" in window.ace || (window.ace.vars = {
            ...
            setup: function () {
                ...
                n.on(a, function (a) {
                    ...
                    var o, l = a.originalEvent.touches ? a.originalEvent.touches[0] : a,
                        c = {coords: [l.pageX, l.pageY], origin: e(a.target)}, d = !1, u = 0, h = 0;
    ...
    var n = a.content_url || !1, r = a.default_url || !1, o = a.loading_icon || "fa-spinner fa-2x orange",
        l = a.loading_text || "", c = a.update_breadcrumbs || "undefined" == typeof a.update_breadcrumbs,
    ...
    if (e.fn.ace_scroll) {
        var t = ace.vars.safari && navigator.userAgent.match(/version\/[1-5]/i), i = e(".sidebar"),
            s = (e(".navbar"), i.find(".nav-list")), n = i.find(".sidebar-toggle"), r = i.find(".sidebar-shortcuts"),
            o = e(window), l = i.get(0), c = s.get(0);
        if (l && c) {
            var d, u, h = null, v = null, p = null, f = null, g = null, m = !1, b = !1, w = a.scroll_to_active || !1,
                _ = a.include_shortcuts || !1, y = a.include_toggle || !1, C = a.smooth_scroll || !1,
                x = a.outside || !1, k = "getComputedStyle" in window ? function () {
    ...
    if ("querySelector" in document && "removeProperty" in document.documentElement.style) {
        ...
        var n = e(".sidebar").eq(0), r = (n.get(0), n.find(".nav-list").get(0)), o = e(".navbar").eq(0), l = o.get(0),
            c = n.hasClass("h-sidebar"), d = "fixed" == o.css("position");
    ...
    var a = function (a) {
        ...
        this.reload = function () {
            ...
            var t = this.$box, i = t.find(".widget-body"), s = null,
